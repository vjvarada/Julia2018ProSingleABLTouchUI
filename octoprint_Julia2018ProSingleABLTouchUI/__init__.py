...
class Julia2018ProSingleABLTouchUI(octoprint.plugin.StartupPlugin):
    ...
    def get_update_information(self):
        return dict(
            Julia2018ProSingleABLTouchUI=dict(
                displayName="Julia2018ProSingleABLTouchUI",
                displayVersion=self._plugin_version,
                # version check: github repository
                type="github_release",
                user="FracktalWorks",
                repo="Julia2018ProSingleABLTouchUI",
                current=self._plugin_version,

                # update method: pip
                pip="https://github.com/FracktalWorks/Julia2018ProSingleABLTouchUI/archive/{target_version}.zip"
            )
        )


__plugin_name__ = "Julia2018ProSingleABLTouchUI"
__plugin_version__ = "0.0.6"


def __plugin_load__():
    global __plugin_implementation__
    __plugin_implementation__ = Julia2018ProSingleABLTouchUI()
